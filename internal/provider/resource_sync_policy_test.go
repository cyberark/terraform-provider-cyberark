...
func TestSyncPolicyResourceUpdate(t *testing.T) {
	t.Parallel()

	// Create a new instance of the syncPolicyResource
	r := provider.NewSyncPolicyResource()
...
func TestSyncPolicyResourceDelete(t *testing.T) {
	t.Parallel()
